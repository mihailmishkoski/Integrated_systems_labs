...
namespace Lab1.Controllers
{
    public class ConcertsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ConcertName,ConcertDate,ConcertPlace,ConcertPrice")] Concert concert)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ConcertName,ConcertDate,ConcertPlace,ConcertPrice")] Concert concert)
        {
            if (id != concert.Id)
            {
                return NotFound();
